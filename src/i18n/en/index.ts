export default {
  ...
  descriptionMeta: "Here I present the projects I've worked on throughout my journey " +
    ...
    "believe that every project I work on should be unique and " +
    "tailored to the client's needs. I hope you'll enjoy " +
    "browsing through my work and find something that inspires or " +
    "interests you!",
  name: "Kate Kurkina",
  ...
  menu: "Menu",
  welcome: "Welcome!",
  description: "Here I present the projects I've worked on throughout my journey " +
    "as a <b>front-end developer</b>. My portfolio includes a variety " +
    "of projects I've built for both <b>clients and personal use</b>. I " +
    "believe that every project I work on should be <b>unique</b> and " +
    "<b>tailored to the client's needs</b>. I hope you'll enjoy " +
    "browsing through my work and find something that <b>inspires or " +
    "interests you</b>!",
  page404: "404 Page",
  portfolio: "Portfolio",
  seeMore: "See more",
  seeMoreProject: "See more of my projects",
  contacts: "Contacts",
  error404: "Page is not available",
  toHome: "To Home",
  ...
  successLink: "Link copied!",
  errorLink: "Can`t copy link",
  moreInfo: "More info",
  projectsData: [
    {
      id: 1,
